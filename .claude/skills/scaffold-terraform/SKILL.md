...
description: Generate complete Terraform Google Module for provisioning a Google Dataflow Job with the given specifications
disable-model-invocation: true
argument-hint: "[region] [project]"
---

Generate a complete Terraform Google Module for provisioning a Google Dataflow Job with the given specifications:
...
|---|---|
| `variables.tf` | **`tf-mod-vars`** — follow its variable authoring patterns, validation rules, and GCP provider reference for the `dataflow_job_config` object |
| `main.tf` | **`tf-mod-main`** — follow its core authoring patterns and GCP provider reference for the `google_dataflow_job` resource |
